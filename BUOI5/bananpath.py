...
for nv in nvs:
    ...
    print(f" - {manv} | {tenv} | {sdt} | {gioitinh}")
...
for hd in hd_nv01:
    ...
    ngaylap = hd.findtext("NGAYLAP")
    soban = hd.findtext("SOBAN")
    tongtien = hd.findtext("TONGTIEN")
    print(f" - {sohd} | Ngày: {ngaylap} | Bàn: {soban} | Tổng: {tongtien}")
